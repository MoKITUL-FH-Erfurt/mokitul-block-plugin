...
/**
 * The task that provides a complete restore of block_mokitul is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/mokitul/backup/moodle2/restore_mokitul_stepslib.php');

/**
 * Restore task for block_mokitul.
 */
class restore_mokitul_block_task extends restore_block_task {
